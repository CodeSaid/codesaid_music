package com.codesaid.lib_commin_ui;
 ...
 * Created By codesaid
 * On :2019-12-04
 * Package Name: com.codesaid.lib_commin_ui
 */
public class HornierItemView extends RelativeLayout {
    ...
    public HornierItemView(Context context) {
        this(context, null);
    }

    public HornierItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HornierItemView(Context context, AttributeSet attrs, int defaultStyle) {
