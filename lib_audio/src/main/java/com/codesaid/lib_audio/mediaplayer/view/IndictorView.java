...
import com.codesaid.lib_audio.mediaplayer.view.adapter.MusicPagerAdapter;
...
public class IndictorView extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private void initData() {
        mQueue = AudioController.getInstance().getAudioBeans();
    ...
    private void initView() {
        ...
        mMusicPagerAdapter = new MusicPagerAdapter(mContext, mQueue);
    ...
    public void onPageSelected(int position) {
        //指定要播放的position
        AudioController.getInstance().setAudioBeanIndex(position);
    }
